package com.example.gqqqqq.lorastop.adapter;
...
public class MyBaseExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            itemHolder.tv_num = (TextView) convertView.findViewById(R.id.tv_num);
            itemHolder.tv_empty = (TextView) convertView.findViewById(R.id.tv_empty);
            convertView.setTag(itemHolder);
        }else{
            itemHolder = (ViewHolderItem) convertView.getTag();
        }
        itemHolder.tv_name.setText(iData.get(groupPosition).get(childPosition).getiName());
        itemHolder.tv_num.setText(iData.get(groupPosition).get(childPosition).getiNum());
        itemHolder.tv_empty.setText(iData.get(groupPosition).get(childPosition).getiEmpty());
        return convertView;
    }
